...
# CONFIG
# =============================
st.set_page_config("Dashboard Comercial - Septiembre CVS 2026", layout="wide")
...
<h1 style="color:white;text-align:center">📊 Dashboard Comercial, Accesorios,CVS PLUS – y Encuestas al 20 de septiembre</h1>
</div>
...
with tab1:
    ...
    with col1:
        ...
        productos_base = ["HOGAR", "POSTPAGO", "TERMINALES", "CVS PLUS", "OTROS", "ACCESORIOS"]
...
def maestro_productos_por_cvs(df, cvs_sel):
    ...
    # ==========================================================
    # CALDAS Y COPACABANA
    # ACCESORIOS NO DEBE MOSTRAR META
    # ==========================================================

    if cvs_sel in ["CALDAS", "COPACABANA"]:
        maestro["ACCESORIOS"] = 0
